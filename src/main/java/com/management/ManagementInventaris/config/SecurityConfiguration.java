        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers(PATCH, "/api/v1/store/update/{storeId}").hasAnyAuthority(ADMIN_UPDATE.name(), MANAGER_UPDATE.name())
                                .requestMatchers(PATCH, "/api/v1/store/update/store-accounting").hasAnyAuthority(ADMIN_UPDATE.name(), MANAGER_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/store/delete/{storeId}").hasAnyAuthority(ADMIN_DELETE.name(), MANAGER_DELETE.name())
